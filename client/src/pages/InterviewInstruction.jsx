  ...
  return (
    <>
      <div className="flex flex-center">
        {/* Move the container slightly to the right */}
        <div className="interview-process-container flex flex-col items-center justify-center"> {/* Center horizontally and vertically */}
        <div style={{ position: "fixed", top: 0, left: 0, width: "200px", zIndex: 1000 }}>
        <TopBar />
      </div> {/* Include the TopBar component */}
